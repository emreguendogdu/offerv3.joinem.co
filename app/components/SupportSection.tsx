...
export function SupportSection() {
  return (
    <section className="bg-white py-16 px-4">
      <div className="mx-auto max-w-[77.625rem] bg-[#F2F2F2] rounded-[48px] p-8 sm:p-16 lg:p-20">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="grid grid-cols-2 gap-4 h-[300px] sm:h-[400px]">
            <div className="relative h-full overflow-hidden rounded-[24px] sm:rounded-[32px]">
              <Image
            ...
            <div className="relative h-full overflow-hidden rounded-[24px] sm:rounded-[40px]">
              <Image
