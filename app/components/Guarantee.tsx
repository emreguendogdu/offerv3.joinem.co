...
export function Guarantee() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[58.75rem] bg-(--color-bg-cream) rounded-[60px] md:rounded-[80px] card relative overflow-hidden flex items-center justify-center">
        <div className="flex flex-col items-center justify-center w-full max-w-[40rem]">
          ...
          <div className="flex flex-col items-center justify-center gap-4">
            ...
            <h2 className="text-(--color-text-dark) font-display text-[1.5rem] md:text-[1.875rem] font-semibold leading-[1.1] tracking-tight text-center md:max-w-lg md:mx-auto">
              Support that fits your life, backed by a simple 100% satisfaction
              guarantee.
            </h2>
            <p className="text-(--color-text-dark) text-sm md:text-base leading-[1.6] opacity-90 text-center tracking-[-0.02rem]">
              We&apos;re so confident in our personalized program, we guarantee
              you&apos;ll lose weight or your money back. It&apos;s that simple.
            </p>
            <Button className="bg-gradient-to-r from-(--color-brand-orange) to-[#EAB308] text-white px-10 py-4 rounded-full font-bold text-xs text-[0.625rem] w-full md:w-auto md:text-xs tracking-[0.075rem] uppercase hover:opacity-90 transition-opacity border-none shadow-lg">
